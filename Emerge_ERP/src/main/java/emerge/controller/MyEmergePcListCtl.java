...
@WebServlet("/MyEmergePcListCtl")
public class MyEmergePcListCtl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			List<MyEmergePcBean> list = model.search();
			RequestDispatcher rd = request.getRequestDispatcher("MyEmergePcListView.jsp");
